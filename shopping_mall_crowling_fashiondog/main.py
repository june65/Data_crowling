...
for page in range(1):
        ...
        webpage = urllib.request.urlopen('https://fashiondog.kr/board/product/list.html')
        ...
        for num in range(13):
                ...
                review_detail =  quote( title[num].find_all("a")[1]["href"] )
                webpage2 = urllib.request.urlopen('https://fashiondog.kr{}'.format(review_detail))
                ...
                if soup2.find('div','detail') != None :
                        ...
                        for img in review_images:
                                ...
                                with urlopen('https:'+img_Url) as f:
                                        with open('C:/Users/82108/Desktop/이준명/Data_crowling/shopping_mall_crowling_fashiondog/image/img' + "_" + str(product_name.replace(' ','')) + "_" + str(product_num) + "_" + str(number) +'.jpg','wb') as h:
                                                img2 = f.read()
                                                h.write(img2)
                                                number+=1  
