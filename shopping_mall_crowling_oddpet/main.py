...
for page in range(1,69):
        ...
        webpage = urllib.request.urlopen('https://odd-pet.com/board/review/4/&page={}'.format(page))
        ...
        for num in range(0,9):
                ...
                webpage2 = urllib.request.urlopen('https://odd-pet.com{}'.format(review_detail))
