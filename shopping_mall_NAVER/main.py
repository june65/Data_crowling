...
import selenium 
driver = webdriver.Chrome("C:/Users/82108/Desktop/이준명/Data_crowling/shopping_mall_selenium/chromedriver")

driver.get("https://m.itsdog.com/shop.html")
driver.implicitly_wait(3)
click_link = driver.find_element_by_class_name('best_Category').find_element_by_tag_name("a")

print(click_link)

driver.find_element_by_xpath('//*[@class="search"]/button[0]').click()
